...
- [`fd()`](https://docs.ropensci.org/mctq/reference/fd.md): compute MCTQ
  work-free days.
- [`so()`](https://docs.ropensci.org/mctq/reference/so.md): compute MCTQ
  local time of sleep onset.
- [`gu()`](https://docs.ropensci.org/mctq/reference/gu.md): compute MCTQ
  local time of getting out of bed.
- [`sdu()`](https://docs.ropensci.org/mctq/reference/sdu.md): compute
  MCTQ sleep duration.
- [`tbt()`](https://docs.ropensci.org/mctq/reference/tbt.md): compute
  MCTQ total time in bed.
- [`msl()`](https://docs.ropensci.org/mctq/reference/msl.md): compute
  MCTQ local time of mid-sleep.
- [`napd()`](https://docs.ropensci.org/mctq/reference/napd.md): compute
  MCTQ nap duration (only for MCTQ Shift).
- [`sd24()`](https://docs.ropensci.org/mctq/reference/sd24.md): compute
  MCTQ 24 hours sleep duration (only for MCTQ Shift).
...
- [`msf_sc()`](https://docs.ropensci.org/mctq/reference/msf_sc.md):
  compute MCTQ chronotype or sleep-corrected local time of mid-sleep on
  work-free days.
- [`sjl()`](https://docs.ropensci.org/mctq/reference/sjl.md) and
...
- [`sjl_weighted()`](https://docs.ropensci.org/mctq/reference/sjl_weighted.md):
  compute MCTQ absolute social jetlag across all shifts (only for MCTQ
  Shift).
